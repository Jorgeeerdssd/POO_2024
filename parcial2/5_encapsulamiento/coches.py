...
#Para utilizar un atributo provado es necario usarlo dentro de un metodo publico
...
#Para utlizar un metodo privado es necario usarlo dentro de un metodo publico
    def getMetodoPublico(self):
      print("Soy un metodo privado")
  #El encapsulamiento o visibilidad es importante porque atravez de el es posible que python sepa como utilizar y manipular los atributos y metodos de la clase
  #atributo publico
